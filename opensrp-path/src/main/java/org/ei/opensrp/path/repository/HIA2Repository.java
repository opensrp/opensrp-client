...
public class HIA2Repository extends BaseRepository {
    ...
    private static final String HIA2_SQL = "CREATE TABLE hia2 (_id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,provider_id VARCHAR NOT NULL,key VARCHAR NOT NULL,dhis_id VARCHAR NOT NULL, value VARCHAR NOT NULL,status VARCHAR,created_at DATETIME NULL,updated_at TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP)";
    ...
    public static final String[] WEIGHT_TABLE_COLUMNS = {ID_COLUMN, PROVIDER_ID, KEY, VALUE, DHIS_ID, STATUS, CREATED_AT_COLUMN, UPDATED_AT_COLUMN};
