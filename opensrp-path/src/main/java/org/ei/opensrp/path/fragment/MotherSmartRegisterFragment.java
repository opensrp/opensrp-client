...
import org.ei.opensrp.path.activity.MotherSmartRegisterActivity;
...
import org.ei.opensrp.path.provider.MotherSmartClientsProvider;
...
public class MotherSmartRegisterFragment extends BaseSmartRegisterFragment {
...
//        ((ChildSmartRegisterActivity) getActivity()).startFormActivity("household_registration", null, null);
        ((MotherSmartRegisterActivity) getActivity()).startFormActivity("woman_member_registration", null, null);
        ...
        public void onClick(View view) {
            ...
            switch (view.getId()) {
                ...
                case R.id.global_search:
                    ((MotherSmartRegisterActivity) getActivity()).startAdvancedSearch();
                    break;

                case R.id.scan_qr_code:
                    ((MotherSmartRegisterActivity) getActivity()).startQrCodeScanner();
                    break;
    ...
    public void countOverDue() {
        ...
        ((MotherSmartRegisterActivity) getActivity()).updateAdvancedSearchFilterCount(count);
    }
