 ...
 */
public class StockSmartRegisterFragment extends SecuredNativeSmartRegisterCursorAdapterFragment {
...
//                        new HouseholdCensusDueDateSort(),
                        ...
                        new CursorCommonObjectSort(getResources().getString(R.string.hh_fwGobhhid_sort),householdSortByGOBHHID())
//""
...
//                .newInstance((StockSmartRegisterActivity) getActivity(), new EditDialogOptionModel(), context.anmLocationController().get(), "new_household_registration")
//                .show(ft, locationDialogTAG);
        ((StockSmartRegisterActivity)getActivity()).startFormActivity("stock", null, null);
    }
