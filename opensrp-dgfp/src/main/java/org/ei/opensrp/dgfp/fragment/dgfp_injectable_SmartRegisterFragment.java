...
//                        getClientsAdapter().notifyDataSetChanged();
    ...
    public void initializeQueries(){
        ...
        countSelect = countqueryBUilder.mainCondition(" details like '%\"Is_Eligible_Injectables\":\"1\"%'  and Not (details like '%\"Visit_Status\":\"10\"%' or details like '%\"Visit_Status\":\"11\"%' or details like '%\"Visit_Status\":\"8\"%')  ");
        ...
        mainSelect = queryBUilder.mainCondition(" details like '%\"Is_Eligible_Injectables\":\"1\"%'  and Not (details like '%\"Visit_Status\":\"10\"%' or details like '%\"Visit_Status\":\"11\"%' or details like '%\"Visit_Status\":\"8\"%')  ");
