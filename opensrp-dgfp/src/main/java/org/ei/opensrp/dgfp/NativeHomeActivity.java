...
import org.ei.opensrp.dgfp.adolescent.adolescentHandler;
...
import org.ei.opensrp.dgfp.child.childformHandler;
import org.ei.opensrp.dgfp.clientDownload.ClientSearchActivity;
import org.ei.opensrp.dgfp.elco.psrfHandler;
...
public class NativeHomeActivity extends SecuredActivity {
    ...
    protected void onCreation() {
        ...
        context.formSubmissionRouter().getHandlerMap().put("child_zero_to_five_form",new childformHandler(this));
        ...
        context.formSubmissionRouter().getHandlerMap().put("census_enrollment",new HouseHoldHandler(this));
        context.formSubmissionRouter().getHandlerMap().put("elco_register",new psrfHandler(this));
        context.formSubmissionRouter().getHandlerMap().put("adolescent_health",new adolescentHandler(this));
