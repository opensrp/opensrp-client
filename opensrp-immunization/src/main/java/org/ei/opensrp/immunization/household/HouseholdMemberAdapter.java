                ...
                public void onClick(View v) {
                    if (age <= 5) {
                        ...
                        new Handler().postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                ((HouseholdSmartRegisterFragment)((SmartRegisterSecuredActivity)(fragment).getActivity()).getBaseFragment()).startChildRegistration(list.get(position).client.getCaseId());
                            }
                        }, 0);
                    }
                        ...
                        new Handler().postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                ((HouseholdSmartRegisterFragment)((SmartRegisterSecuredActivity)(fragment).getActivity()).getBaseFragment()).startWomanRegistration(list.get(position).client.getCaseId());
                            }
                        }, 0);
                    }
                    else {
