...
public class BidanLocationSelectorDialogFragment extends DialogFragment {
    ...
    private BidanLocationSelectorDialogFragment(SecuredNativeSmartRegisterActivity activity,
    ...
    public static BidanLocationSelectorDialogFragment newInstance(
            SecuredNativeSmartRegisterActivity activity,
            DialogOptionModel dialogOptionModel,
            String locationJSONString,String formname) {
        return new BidanLocationSelectorDialogFragment(activity, dialogOptionModel, locationJSONString,formname);
    }
