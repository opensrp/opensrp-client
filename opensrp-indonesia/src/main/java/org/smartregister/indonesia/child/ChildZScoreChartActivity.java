 ...
 */
public class ChildZScoreChartActivity extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.zscore_chart_layout);
    ...
    public void initializeActionNavBar(){
        detailActivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(ChildZScoreChartActivity.this, ChildDetailActivity.class));
        ...
        lfaActivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                ChildGrowthChartActivity.client = client;
                startActivity(new Intent(ChildZScoreChartActivity.this, ChildGrowthChartActivity.class));
                overridePendingTransition(0, 0);
            }
        });
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                startActivity(new Intent(ChildZScoreChartActivity.this, AnakDetailActivity.class));
                overridePendingTransition(0, 0);
            }
        });
    }
